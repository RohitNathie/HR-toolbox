        ...
        <div class="child-container">
            ...
            <div class="tool-instruments row">
                ...
                <div class="instruments-menu col-lg-4 col-12 flex-shrink-1">
                    ...
                    <ul>
                        <a href="resources/pdf/VNO-NCW Instrument onboarding monitor per mw def.pdf" download><li><i class="bi bi-download"></i> Download Instrument </li></a>
                    </ul>
                    <div class="col"><i class="bi bi-person-check"></i> IMPLEMENTATIEPLAN</div>
                    <ul>
                        <a href="resources/pdf/VNO-NCW Implementatieplan onboarding monitor def.pdf" download><li><i class="bi bi-download"></i> Download Implementatieplan</li></a>
                    </ul>
                </div>
            </div>
            <!--- Content ends here -->
