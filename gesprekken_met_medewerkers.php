        ...
        <div class="child-container">
            ...
            <div class="tool-instruments row">
                <div class="col-lg-8 col-12 flex-grow-1">
                    <h3 class="header breadcrumb_menu"><a href="/index.php">TOOLBOX</a> / <a href="/doorstroom.php">DOORSTROOM</a> / GESPREKKEN MET MEDEWERKERS</h3>
                    <h1>GESPREKKEN MET MEDEWERKERS</h1>
                    <div class="parent">
                ...
                <div class="instruments-menu col-lg-4 col-12 flex-shrink-1">
                    ...
                    <ul>
                        <a href="resources/pdf/VNO-NCW Instrument Tips voor een goed gesprek def.pdf" download>
                            <li><i class="bi bi-download"></i> Tips voor een goed gesprek</li>
                        </a>
                    </ul>
                    <div class="col"><i class="bi bi-person-gear"></i> INSTRUMENTEN</div>
                    <ul>
                        <a href="resources/pdf/VNO-NCW Instrument Planningsgesprek def.pdf" download>
                            <li><i class="bi bi-download"></i> Planningsgesprek</li>
                        </a>
                        <a href="resources/pdf/VNO-NCW Tips medewerker in ontwikkeling krijgen def.pdf" download>
                            <li><i class="bi bi-download"></i> Ontwikkelgesprek</li>
                        </a>
                        <a href="resources/pdf/VNO-NCW Instrument Beloningsgesprekken def.pdf" download>
                            <li><i class="bi bi-download"></i> Beloningsgesprekken</li>
                        </a>
                        <a href="resources/pdf/VNO-NCW Instrument Medewerkerstevredenheidsmonitor def.pdf" download>
                    ...
                    <ul>
                        <a href="resources/pdf/VNO-NCW IImplementatieplan Ontwikkelgesprekken (POP gesprekken) def.pdf" download>
