        ...
        <div class="child-container">
            ...
            <div class="tool-instruments row">
                ...
                <div class="instruments-menu col-lg-4 col-12 flex-shrink-1">
                    ...
                    <ul>
                        <a href="resources/pdf/VNO-NCW Instrument_exitgesprek def.pdf" download><li><i class="bi bi-download"></i> Exitgesprek</li></a>
                    </ul>
                    <div class="col"><i class="bi bi-person-check"></i> IMPLEMENTATIEPLAN</div>
                    <ul>
                        <a href="resources/pdf/VNO-NCW Implementatieplan exitgesprek def.pdf" download><li><i class="bi bi-download"></i> Exitgesprek</li></a>
                    </ul>
                    </div>
                </div>
            </div>
