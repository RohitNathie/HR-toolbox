        ...
        <div class="child-container">
            ...
            <div class="tool-instruments row">
                <div class="col-lg-8 col-12 flex-grow-1">
                    <h3 class="header breadcrumb_menu"><a href="/index.php">TOOLBOX</a> / <a href="/uitstroom.php">UITSTROOM</a> / VERZUIM</h3>
                    <h1>VERZUIM</h1>
                    <div class="parent">
                        <p>Benieuwd hoe je uitval van medewerkers kan voorkomen? Kijk snel verder!</p>
                    </div>
                </div>
